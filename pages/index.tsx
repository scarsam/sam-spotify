      ...
      <nav className="flex items-center justify-between	bg-white rounded-sm px-12 py-4">
        ...
        <div className="flex items-center">
          <p className="pl-2 pr-2">
            <a href="https://github.com/scarsam">
              <svg
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <div className="row-span-4 bg-blue rounded-sm shadow-sm p-10">
            <h1 className="text-3xl text-center mb-12">
              <a href="https://www.linkedin.com/jobs/view/2307885871/?refId=674511c8-710e-4cb5-8a59-aa7f549e4039">
                Web Engineer
            ...
            <article className="prose max-w-2xl m-auto">
              ...
              <p>
                ...
                company called <a href="https://gusto.com">Gusto</a>. I've been
                with Gusto since 2015 both as a product designer and for the
                last two years as a frontend developer
              </p>
              <p>
              ...
              <div className="text-center">
                ...
                <p>
                  <a href={user.external_urls.spotify}>Sam Öjling</a>
                </p>
              </div>
            </article>
          </div>
